...
class ChooseTimeDialogNew extends StatelessWidget {
        ...
        child: Row(
          children: [
            textfieldOfDialog("Hour",
                chooseTimeDialogController.endHour ),
            Flexible(
                flex: 1,
                fit: FlexFit.tight,
                child: Container(
            ...
            textfieldOfDialog(
              "Minute",
              chooseTimeDialogController.endMinute,
            ),
          ],
        ),
      );
  ...
  AnimatedButtonBar amPmSection() {
    return AnimatedButtonBar(
      ...
      children: [
        ButtonBarEntry(
            onTap: () {
              chooseTimeDialogController.endTimeFormat = "PM";
            },
            child: const Text('PM')),
        ButtonBarEntry(
            onTap: () {
              chooseTimeDialogController.endTimeFormat  = "AM";
            },
            child: const Text('AM')),
      ],
    );
