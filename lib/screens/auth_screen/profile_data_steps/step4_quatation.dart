...
class Step4Qutation extends StatefulWidget {
  const Step4Qutation({Key? key}) : super(key: key);
  static const id = "step_4_screen";

  @override
  State<Step4Qutation> createState() => _Step4QutationState();
}

class _Step4QutationState extends State<Step4Qutation> {
                  ...
                  child: Column(
                    children: [
                      ...
                      FarenowRadioButtons(
                        ...
                        list: controller.stepFourQutationlist,
                        isRadio: true,
                      ),
                      150.height,
                    ],
                          ...
                          FarenowButton(
                              ...
                              onPressed: () {
                                if (selectedService.isNotEmpty) {
                                  if (selectedService
                                      .contains(controller.stepFourQutationlist[0])) {
                                    Navigator.pushNamed(context,
                                        BusinessProfileSettingsScreen.id,
                                        arguments: true);
                                  }
                                } else {
