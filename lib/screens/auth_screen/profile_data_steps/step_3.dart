...
import 'package:fare_now_provider/screens/auth_screen/profile_data_steps/step4_quatation.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      FarenowRadioButtons(
                        onSelected: (v1, v2, v3) {
                          selectedRole = v1[0];
                          isIndividualSelected = selectedRole == "Individual";
                          print(selectedRole);
                          ...
                          print(_profileScreenController
                              .userData.value.providerType);
                          setState(() {});
                        },
                        list: controller.stepThreelist,
                        isRadio: true,
                      ),
                      150.height,
                    ],
                          ...
                          FarenowButton(
                              ...
                              onPressed: () {
                                if (selectedRole.isNotEmpty) {
                                  if (selectedRole
                                      .contains(controller.stepThreelist[0])) {
                                    Navigator.pushNamed(
                                      context,
                                      Step4.id,
                                      arguments: true,
                                    ...
                                    Get.to(Step4Qutation.new);
                                  }
                                } else {
                                  AppDialogUtils.errorDialog("Select Role");
                                }
