...
class TableCalendarBase extends StatefulWidget {
  ...
  final dowDecoration;
  final rowDecoration;
  final formatAnimationDuration;
  final formatAnimationCurve;
  final pageAnimationEnabled;
  final pageAnimationDuration;
  final pageAnimationCurve;
  final startingDayOfWeek;
  final availableGestures;
  final simpleSwipeConfig;
  final availableCalendarFormats;
  final onVerticalSwipe;
  final onPageChanged;
...
class _TableCalendarBaseState extends State<TableCalendarBase>
  ...
  double _getPageHeight(int rowCount) {
    ...
    var abc = widget.rowHeight ?? 0;
    return dowHeight + (rowCount * abc);
  }
