...
import 'package:fare_now_provider/custom_packages/calendar/calendar_page.dart';
...
class CalendarCore extends StatelessWidget {
  ...
  DateTime _getFocusedDay(
    ...
    switch (format) {
      case CalendarFormat.month:
        day = DateTime.utc(prevFocusedDay.year,
            int.parse((prevFocusedDay.month + pageDif).toString()));
        break;
      case CalendarFormat.twoWeeks:
        day = DateTime.utc(prevFocusedDay.year, prevFocusedDay.month,
            int.parse((prevFocusedDay.day + pageDif * 14).toString()));
        break;
      case CalendarFormat.week:
        day = DateTime.utc(prevFocusedDay.year, prevFocusedDay.month,
            int.parse((prevFocusedDay.day + pageDif * 7).toString()));
        break;
    }
