import 'package:fare_now_provider/custom_packages/card_ui/extra/card_type.dart';
...
Widget getCardTypeIcon({CardType? cardType, String? cardNumber}) {
  switch (cardType ?? getCardType(cardNumber!)) {
    case CardType.americanExpress:
      return Image.asset(
        'assets/providerImages/png/card_provider/american_express.png',
        width: 55,
        height: 40,
    ...
    case CardType.dinersClub:
      return Image.asset(
        'assets/providerImages/png/card_provider/diners_club.png',
        width: 40,
        height: 40,
        // package: 'awesome_card',
      );
    case CardType.discover:
      return Image.asset(
        'assets/providerImages/png/card_provider/discover.png',
        width: 70,
        height: 50,
        // package: 'awesome_card',
      );
    case CardType.jcb:
      return Image.asset(
        'assets/providerImages/png/card_provider/jcb.png',
        width: 40,
        height: 40,
        // package: 'awesome_card',
      );
    case CardType.masterCard:
      return Image.asset(
        'assets/providerImages/png/card_provider/master_card.png',
        width: 55,
        height: 40,
        // package: 'awesome_card',
      );
    case CardType.maestro:
      return Image.asset(
        'assets/providerImages/png/card_provider/maestro.png',
        width: 55,
        height: 40,
        // package: 'awesome_card',
      );
    case CardType.rupay:
      return Image.asset(
        'assets/providerImages/png/card_provider/rupay.png',
        width: 80,
        height: 50,
        // package: 'awesome_card',
      );
    case CardType.visa:
      return Image.asset(
        'assets/providerImages/png/card_provider/visa.png',
        width: 55,
        height: 40,
        // package: 'awesome_card',
      );
    case CardType.elo:
      return Image.asset(
        'assets/providerImages/png/card_provider/elo.png',
        width: 50,
        height: 50,
        // package: 'awesome_card',
      );
